...
export function PlannerPage() {
 ...
 return (
   /* 🛠️ PENYEMPURNAAN CONTAINER: Menggunakan tinggi dinamis dvh agar fleksibel merespons kemunculan keyboard HP */
   <div style={{ 
     display: 'flex',
     ...
     {/* ── Timeline ── */}
     {/* 🛠️ PENYEMPURNAAN TIMELINE: Area timeline sekarang otomatis mengambil sisa ruang kosong yang tersedia */}
     <div style={{ padding: '0 16px', flex: 1, overflowY: 'hidden', display: 'flex', flexDirection: 'column' }}>
       <PlannerTimeline
         C={C}
         events={events}
         nowMin={nowMin}
