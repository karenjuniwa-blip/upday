...
export type PlannerEvent = DbPlannerEvent
...
export interface Database {
  public: {
    Tables: {
      ...
      tasks: {
        Row:    DbTask
        Insert: Partial<DbTask>
        Update: Partial<DbTask>
      }
      subtasks: {
        Row:    DbSubtask
        Insert: Partial<DbSubtask>
        Update: Partial<DbSubtask>
      }
      habits: {
        Row:    DbHabit
        Insert: Partial<DbHabit>
        Update: Partial<DbHabit>
      }
      habit_logs: {
        Row:    DbHabitLog
        Insert: Partial<DbHabitLog>
        Update: Partial<DbHabitLog>
      }
      planner_events: {
        Row:    DbPlannerEvent
        Insert: Partial<DbPlannerEvent>
        Update: Partial<DbPlannerEvent>
      }
    }
  }
}
